...
% ============================================================
% ACL [review] 双栏行号永久修复 — 防止行号与正文/对栏内容重叠
% Bug: acl.sty 默认 \linenumbersep=1.6cm，在双栏密集排版下
%      左/右栏行号会伸入对栏内容，造成视觉重叠。
% Fix: (1) 行号字号缩小到 \tiny  (2) sep 改 4pt  (3) 更轻颜色
% ============================================================
\AtBeginDocument{%
  \setlength{\linenumbersep}{4pt}%
  \renewcommand\linenumberfont{\normalfont\tiny\sffamily\color{black!25}}%
}
